      ...
      <div className="review__container container grid gap-12 xs:max-w-sm sm:max-w-md md:max-w-lg xl:max-w-4xl xl:grid-cols-2 xl:items-center 2xl:max-w-5xl">
        <div className="review__data">
          ...
          <figure class="max-w-screen-md">
            ...
            <blockquote>
              <p class="py-10 text-2xl  text-gray-900 dark:text-white">
                " Absolutely fantastic experience with Emirates Adventours in
                Dubai and the UAE! From the breathtaking desert safari to the
                stunning Burj Khalifa, every moment was meticulously planned.
                The knowledgeable guides, comfortable transportation, and
                exceptional service made this trip unforgettable. Highly
                recommend! "
              </p>
            </blockquote>
          </figure>
        ...
        <img
          src={customer}
          alt="review img"
          className="review__img shadow-lg"
        />
      </div>
    </section>
  );
