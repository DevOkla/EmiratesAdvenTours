        ...
        <div className="services__group grid grid-cols-[.8fr] justify-center gap-8 xs:mx-auto xs:max-w-sm sm:max-w-md lg:max-w-2xl lg:grid-cols-2 2xl:max-w-5xl 2xl:grid-cols-3">
          {serviceData.slice(0, 3).map((item, index) => {
            return (
              <div
                key={index}
                className="services__card grid gap-6 rounded-lg border-2 border-gray-200 bg-white px-6 py-8 transition-all duration-400 hover:border-blue-600 hover:shadow-xl dark:border-gray-800 dark:bg-gray-900 dark:hover:border-blue-600"
              >
